...
function Install {
  ...
  $homeConfigurations = $homeBaseConfigurations + [Configuration]::BaseHomePackages;
  ...
  $configurationDirs = $effectiveConfigurations | ForEach-Object { switch ($_) {
      BasePackages { "base-packages" }
      BaseHomePackages { "base-home-packages" }
      Sshd { "sshd" }
